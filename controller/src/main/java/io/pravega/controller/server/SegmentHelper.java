...
public class SegmentHelper implements AutoCloseable {
    ...
    public CompletableFuture<WireCommands.SegmentRead> flushToStorage(String qualifiedName, PravegaNodeUri uri, String delegationToken) {
        ...
        return sendRequest(connection, requestId, request)
                .thenApply(r -> {
                    handleReply(requestId, r, connection, qualifiedName, WireCommands.FlushToStorage.class, type);
